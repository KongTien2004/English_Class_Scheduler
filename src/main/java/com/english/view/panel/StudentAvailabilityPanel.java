...
public class StudentAvailabilityPanel extends JPanel {
    ...
    private JPanel createHeader() {
        ...
        JLabel titleLabel = new JLabel("Student Availability Management");
    ...
    private JScrollPane createTablePanel() {
        String[] columns = {
                "Availability ID", "Student ID", "Day of Week", "Start Time", "End Time"
        };
    ...
    private void showAddAvailabilityDialog() {
        JDialog dialog = new JDialog((Frame) SwingUtilities.getWindowAncestor(this), "Add New Student Availability", true);
        ...
        saveButton.addActionListener(e -> {
            ...
            JOptionPane.showMessageDialog(dialog, "Student availability added successfully!");
            dialog.dispose();
            refreshTable();
        });
