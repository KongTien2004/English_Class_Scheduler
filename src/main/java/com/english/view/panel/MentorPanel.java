        ...
        try {
            ...
            for (Mentor mentor : mentors) {
                Object[] row = {
                    ...
                    mentor.getEmail() != null ? mentor.getEmail() : "",
                    mentor.getCertifiedBand(),
                    mentor.isCanTeachGeneral(),
                    mentor.isCanTeachAcademic(),
                    mentor.isAvailable(),
                    mentor.getMentorAddress() != null ? mentor.getMentorAddress() : ""
                };
